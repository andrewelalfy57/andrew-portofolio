        ...
        >
          {projects.map((p) => (
            <motion.div key={p.title} variants={{ hidden: { opacity: 0, y: 16 }, show: { opacity: 1, y: 0 } }}>
              <Card className="overflow-hidden border-slate-200/60 bg-white/80 shadow-lg transition-all hover:-translate-y-1 hover:shadow-2xl dark:border-slate-700/60 dark:bg-slate-900/50">
                <div className="relative h-48 w-full bg-gradient-to-br from-cyan-500 to-pink-500">
                  <Image
                  ...
                  />
                  <div className="absolute left-3 top-3 inline-flex items-center gap-1 rounded-full bg-white/80 px-2 py-1 text-xs font-semibold text-slate-800 backdrop-blur dark:bg-slate-900/60 dark:text-slate-100">
                ...
                <div className="space-y-3 p-5">
                  ...
                  <div className="flex gap-2 pt-2">
                    {p.live && (
                      <Button asChild size="sm" className="bg-gradient-to-r from-cyan-500 to-pink-500">
