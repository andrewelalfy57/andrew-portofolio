    ...
    <section className="relative bg-white py-16 dark:bg-[#0a0e27]">
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          <Card className="border-slate-200/60 bg-white/80 p-6 shadow-lg transition-all hover:-translate-y-1 dark:border-slate-700/60 dark:bg-slate-900/50">
          ...
          <Card className="border-slate-200/60 bg-white/80 p-6 shadow-lg transition-all hover:-translate-y-1 dark:border-slate-700/60 dark:bg-slate-900/50">
            <Phone className="mb-3 h-8 w-8 text-pink-500" />
          ...
          <Card className="border-slate-200/60 bg-white/80 p-6 shadow-lg transition-all hover:-translate-y-1 dark:border-slate-700/60 dark:bg-slate-900/50">
            <MapPin className="mb-3 h-8 w-8 text-violet-500" />
